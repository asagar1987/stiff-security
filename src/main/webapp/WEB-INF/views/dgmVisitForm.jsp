...
<fieldset>
	<legend class="labelsub">Submit Visit Report</legend>
	<form:form action="${pageContext.request.contextPath}/forms/dgmVisitForm" method="post" commandName="dgmVisitForm" >
	<table width="90%" border="1px" style="border-collapse:collapse;margin-left:auto;margin-right:auto;" id="dataTable">
		...
		<tr>
			<td width="50%"><span class="labelsub">Select Visit Date</span></td>
			<td width="50%">
		...
		<tr>
			<td width="50%"></td>
    		<td width="50%" align="right"><input type="submit" value="Submit Visit Report" id="gobutton"/></td>
    	</tr>
