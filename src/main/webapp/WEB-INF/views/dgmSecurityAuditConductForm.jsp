...
<fieldset>
	<legend class="labelsub">Submit Security Audit Conduct Report</legend>
	<form:form action="${pageContext.request.contextPath}/forms/dgmSecurityAuditConductForm" method="post" commandName="dgmSecurityAuditConductForm" >
	<table width="90%" border="1px" style="border-collapse:collapse;margin-left:auto;margin-right:auto;" id="dataTable">
		<tr>
			<td width="50%"><span class="labelsub">Site Name</span></td>
			<td width="50%"><form:input path="siteName"/></td>
		</tr>
		
		<tr>
			<td width="50%"><span class="labelsub">Site Address</span></td>
			<td width="50%">
		...
		<tr>
			<td width="50%"><span class="labelsub">Select Security Audit Conduct Date</span></td>
			<td width="50%">
		...
		<tr>
			<td width="50%"></td>
    		<td width="50%" align="right"><input type="submit" value="Submit Security Audit Conduct Report" id="gobutton"/></td>
    	</tr>
