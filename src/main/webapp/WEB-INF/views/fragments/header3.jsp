...
<table width="100%" style="border:none; border-collapse:collapse;" height="15%">
	...
	<tr height="40px" class="menu">
		...
		<td width="20%">
			<a href="${pageContext.request.contextPath}/forms/marketingHome" ><span class="menuLabel">My Home</span></a>
		</td>
		<td width="20%">
			<a href="${pageContext.request.contextPath}/forms/meetingForm" ><span class="menuLabel">Meetings</span></a>
			
		</td>
		<td width="20%" id="Designations">
			<a href="${pageContext.request.contextPath}/forms/visitForm" ><span class="menuLabel">Visits</span></a>
		</td>
		<td width="20%">
			<a href="${pageContext.request.contextPath}/forms/followupForm" ><span class="menuLabel">Follow-ups</span></a>
		</td>
		<td width="22%">
