...
<table width="100%" style="border:none; border-collapse:collapse;" height="15%">
	...
	<tr height="40px" class="menu">
		...
		<td width="20%">
			<a href="${pageContext.request.contextPath}/forms/dgmHome" ><span class="menuLabel">My Home</span></a>
		</td>
		<td width="20%">
			<a href="${pageContext.request.contextPath}/forms/dailyStatusReportForm" ><span class="menuLabel">Daily Status Report</span></a>
			
		</td>
		<td width="20%" id="Designations">
			<a href="${pageContext.request.contextPath}/forms/dgmVisitForm" ><span class="menuLabel">Visits</span></a>
		</td>
		<td width="20%">
			<a href="${pageContext.request.contextPath}/forms/dgmNightConductForm" ><span class="menuLabel">Night Conduct</span></a>
		</td>
		<td width="20%">
			<a href="${pageContext.request.contextPath}/forms/dgmTrainingConductForm" ><span class="menuLabel">Training Conduct</span></a>
		</td>
		<td width="20%">
			<a href="${pageContext.request.contextPath}/forms/dgmSecurityAuditConductForm" ><span class="menuLabel">Security Audit Conduct</span></a>
		</td>
		<td width="2%">
		</td>
		<td width="2%">
