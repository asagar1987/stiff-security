...
<fieldset>
	<legend class="labelsub">Submit Meeting Report</legend>
	<form:form action="${pageContext.request.contextPath}/forms/meetingForm" method="post" commandName="meetingForm" >
	<table width="90%" border="1px" style="border-collapse:collapse;margin-left:auto;margin-right:auto;" id="dataTable">
		...
		<tr>
			<td width="50%"><span class="labelsub">Select Meeting Date</span></td>
			<td width="50%">
				<form:input id="datepicker" path="meetingDate"/>
			</td>
		</tr>
		...
		<tr>
			<td width="50%"></td>
    		<td width="50%" align="right"><input type="submit" value="Submit Meeting Report" id="gobutton"/></td>
    	</tr>
