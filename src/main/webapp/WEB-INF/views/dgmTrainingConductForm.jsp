...
<fieldset>
	<legend class="labelsub">Submit Training Conduct Report</legend>
	<form:form action="${pageContext.request.contextPath}/forms/dgmTrainingConductForm" method="post" commandName="dgmTrainingConductForm" >
	<table width="90%" border="1px" style="border-collapse:collapse;margin-left:auto;margin-right:auto;" id="dataTable">
		...
		<tr>
			<td width="50%"><span class="labelsub">Select Training Conduct Date</span></td>
			<td width="50%">
		...
		<tr>
			<td width="50%"></td>
    		<td width="50%" align="right"><input type="submit" value="Submit Training Conduct Report" id="gobutton"/></td>
    	</tr>
