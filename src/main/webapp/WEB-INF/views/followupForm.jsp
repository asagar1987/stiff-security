...
<fieldset>
	<legend class="labelsub">Submit Follow-up Report</legend>
	<form:form action="${pageContext.request.contextPath}/forms/followupForm" method="post" commandName="followupForm" >
	<table width="90%" border="1px" style="border-collapse:collapse;margin-left:auto;margin-right:auto;" id="dataTable">
		...
		<tr>
			<td width="50%"><span class="labelsub">Select Follow-up Date</span></td>
			<td width="50%">
				<form:input id="datepicker" path="followupDate"/>
			</td>
		</tr>
		...
		<tr>
			<td width="50%"></td>
    		<td width="50%" align="right"><input type="submit" value="Submit Follow-up Report" id="gobutton"/></td>
    	</tr>
