...
public interface IDGMDailyStatusReportController
{
	...
	String getdata(DailyStatusReportForm dgmDailyStatusReportForm, BindingResult result, Map model,
			HttpSession session);
	...
	String processForm(DailyStatusReportForm dgmDailyStatusReportForm, BindingResult result, Map model,
			HttpSession session);
